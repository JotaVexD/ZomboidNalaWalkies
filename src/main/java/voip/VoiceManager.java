...
public class VoiceManager {
	...
	private long getuserplaysound(int var1) {
					...
					if (var12 != IsoPlayer.getInstance()) {
						...
						while(true) {
							while(true) {
								...
								} while(var13.userplaymute);

								if (var12.isInvisible()) {
									if (!IsoPlayer.getInstance().isInvisible()) {
										continue;
									}
	...
	public void VMServerBan(int var1, boolean var2) {
		RakVoice var10000 = this.voice;
